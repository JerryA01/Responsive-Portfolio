  ...
  return (
    ...
    >
      ...
      <div className={`${showBorders ? "border border-blue-500" : ""} col-span-3 flex flex-col gap-6 mt-1`}>
        ...
        <div className="w-2/3 h-[2px] bg-white opacity-80 mx-auto mt-12 mb-2 rounded-full py-4">
      ...
      {/* === Bottom Row (YouTube Centered, Text on Right) === */}
      <div className={`${showBorders ? "border border-blue-500" : ""} col-span-3 mt-27`}>
        ...
        <div className="w-full flex flex-row justify-start items-start">
          ...
          {/* Video Frame - Left */}
          <div className="sway p-3 rounded-lg bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 animate-spinSlow mt-4">
