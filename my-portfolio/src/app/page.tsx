...
export default function Home() {
  ...
  return (
    <div
      className={`grid grid-cols-1 lg:grid-cols-3 lg:grid-cols-3 md:grid-cols-1 gap-y-0 gap-x-0 p-8 ${showBorders ? "border border-white-400" : ""
        }`}
    ...
    >
      ...
      <div className={`${showBorders ? "border border-blue-500" : ""} col-span-1 lg:col-span-3 flex flex-col lg:flex-row items-center lg:items-start lg:justify-between xl:gap-50 xl:justify-start 2xl:translate-x-16 2xl:gap-179`}>
        {/* Text */}
        <div className="text-center lg:translate-x-70 xl:translate-x-90 2xl:translate-x-90 md:translate-x-40">
          <div className="font-raleway text-7xl md:text-5xl text-white drop-shadow-md font-light mb-2 mt-4">
            Jerry Arthur
          </div>
        ...
        {/* Image */}
        <div className="flex justify-center w-1/3 2xl:-translate-x-45 md:">
        ...
        <div className={`${showBorders ? "border border-blue-500 2xl:mt-5" : ""} col-span-3 `}>
          <h2 className="sway k text-center text-3xl sm:text-4xl md:text-4xl lg:text-4xl font-bold text-blue-700 font-raleway">
            My Projects
          </h2>
        </div>
        ...
        <div className={`${showBorders ? "border border-blue-500" : ""} col-span-1 lg:col-span-3 lg:mt-27 `}>
          ...
          <div className={`sway flex flex-col lg:flex-row lg:justify-between items-center lg:mb-1 mt-5 lg:-mt-10  ${showBorders ? "border border-red-500" : ""}`}>
            {/* Left Title */}
            <div className="font-raleway text-lg 2xl:text-4xl sm:text-3xl lg:text-2xl text-blue-700 font-semibold text-center xl:text-3xl lg:ml-26 xl:ml-45 2xl:ml-80">
          ...
          <div className="w-full flex flex-col items-center lg:flex-row lg:justify-start lg:items-start 2xl:mt-13 2xl:gap-x-3 xl:gap-x-3 lg:gap-x-3">
            ...
            <div className="2xl:translate-x-5 block lg:hidden xl:hidden 2xl:block sway w-[300px] h-[350px] sm:w-[330px] sm:h-[370px] md:w-[390px] md:h-[410px]  2xl:w-[750px] 2xl:h-[370px] p-3 bg-blue-800 text-white rounded-full font-raleway text-center shadow-lg mt-5 lg:mt-1 lg:-ml-1">
            ...
            <div className="lg:hidden sway w-full flex justify-center mt-4 ">
              <div className="font-raleway text-lg sm:text-3xl md:text-4xl text-blue-700 font-semibold text-center">
                Tic Tac Toe Game
              </div>
            </div>
            ...
            <div className="2xl:z-[-10] 2xl:-translate-x-5  block lg:hidden xl:hidden 2xl:block  2xl:w-[750px] 2xl:h-[370px] sway w-[300px] h-[350px] sm:w-[330px] sm:h-[370px] md:w-[390px] md:h-[410px] lg:h-[350px] lg:w-[300px] p-4 bg-blue-800 text-white rounded-full font-raleway text-center shadow-lg mt-6 lg:mt-1">
        ...
        {/* === Bottom Row () === */}
        <div className={`${showBorders ? "border border-white-500" : ""} col-span-3 2xl:col-span-1 -mt-7 2xl:mt-7`}>
          ...
          <div className={`${showBorders ? "border border-green-500 2xl:mt-5 2xl:ml-0" : ""}`}>
            ...
            <div className="w-full flex flex-col lg:flex-row items-center justify-start lg:-mt-9 block lg:hidden xl:hidden 2xl:block 2xl:-mt-86 ">
              ...
              {/* Video Frame - Left */}
              <div className="2xl:-mt-84 2xl:-mr-63 sway block p-3 rounded-lg bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 animate-spinSlow mt-4 z-10 lg:-translate-x-0 max-w-[520px] mx-auto">
          ...
          <div className="hidden lg:flex lg:flex-row lg:justify-between 2xl:hidden">
            {/* Left Box */}
            <div className="sway w-[300px] h-[350px] p-4 bg-blue-800 text-white rounded-full font-raleway text-center shadow-lg mt-5 lg:mt-1 lg:translate-x-20">
              <h3 className="text-xl font-semibold mb-2 text-blue-200 mt-7">What This App Does</h3>
              <p>
                Chirrup is a social media app for university students with real-time posts, media sharing, and threaded comments.
                <br /><br />
            ...
            {/* Right Box */}
            <div className="sway w-[300px] h-[350px] p-4 bg-blue-800 text-white rounded-full font-raleway text-center shadow-lg mt-6 lg:mt-1 lg:-translate-x-18 lg:z-[-10]">
              <h3 className="text-xl font-semibold mb-2 text-blue-200 mt-7">What This Game Does</h3>
              <p>
                Multiplayer Tic Tac Toe game built in Java with real-time play, GUI controls, and synchronized server-client communication.
                <br /><br />
